...
public class Geometric {
    ...
    static ArrayList<IShape> shapes = new ArrayList<>();
    ...
    public static Rectangle getRectangle(ArrayList<String> arguments) {
    ...
    public static Triangle getTriangle(ArrayList<String> arguments) {
    ...
    public static Circle getCircle(ArrayList<String> arguments) {
    ...
    public static LineSegment getLineSegment(ArrayList<String> arguments) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(String.format("Max area\n" + getShapeInfo(shapeWithMaxArea)) + "\n");
        System.out.println(String.format("Min perimeter\n" + getShapeInfo(shapeWithMinPerimeter)));
    }
}